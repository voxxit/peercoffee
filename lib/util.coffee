BinaryPack = require('../deps/js-binarypack/dist/binarypack.js').BinaryPack
RTCPeerConnection = require('peer-connection')
...
util =
  ...
  chunkedMTU: 16300 # The original 60000 bytes setting does not work when
